...
public class AStarPathingStrategyAcceptanceTestsReversed {
   ...
   public void test01_computePath01() {
      ...
      List<Point> path =
              strategy.computePath(start, end,
                      ...
                      AStarPathingStrategyAcceptanceTestsReversed::neighbors,
      ...
      assertEquals(expected.reversed(), path);
   }
   ...
   public void test12_computePath12_diag_card_neighbors() {
      ...
      List<Point> expected = List.of(new Point(5, 5), new Point(4, 6), new Point(3, 6), new Point(2, 6),
              new Point(1, 5), new Point(2, 4));
      assertEquals(expected.reversed(), path);
   }
   ...
   public void test13_computePath13_within_reach_ish() {
      ...
      List<Point> path =
              strategy.computePath(new Point(5, 4),
                      new Point(2, 4),
                      p -> withinBounds(p, grid) && grid[getY(p)][getX(p)] != GridValues.OBSTACLE,
                      AStarPathingStrategyAcceptanceTestsReversed::two_doors_down,
                      PathingStrategy.CARDINAL_NEIGHBORS);
